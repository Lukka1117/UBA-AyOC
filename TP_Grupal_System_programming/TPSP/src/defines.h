...
#define PRIVILEGE_LEVEL_KERNEL 0x0
#define PRIVILEGE_LEVEL_USER 0x3
...
#define GDT_RPL_LEVEL_3 0b0000000000000011

#define GDT_CODE_0_SEL (GDT_IDX_CODE_0 << 3)
#define GDT_DATA_0_SEL (GDT_IDX_DATA_0 << 3)
#define GDT_CODE_3_SEL ((GDT_IDX_CODE_3 << 3) | GDT_RPL_LEVEL_3)
#define GDT_DATA_3_SEL ((GDT_IDX_DATA_3 << 3) | GDT_RPL_LEVEL_3)
...
#define FLAT_SEGM_SIZE (uint32_t)817 << 20
#define VIDEO_SEGM_SIZE GDT_LIMIT_BYTES((uint32_t)(80 * 50 * 2))
...
#define SHARED_MEM_START 0X1D000

// Tipos de descriptor de segmento para la TSS
