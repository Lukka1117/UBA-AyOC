...
caso_t* array_casos_por_nivel(caso_t* arreglo_casos, int largo, int nivel);

void calcular_cantidades_totales(caso_t* arreglo_casos, int largo);

;void calcular_cantidades_ID(caso_t* arreglo_casos, int largo, uint32_t usuario_id);
